...
ELEMENT_TYPES = [TABLE, PIECHART, BARCHART, VIDEOENGAGEMENT, COLUMNCHART, LINECHART, SCATTERCHART, AREACHART, CANDLESTICKCHART, GOOGLEMAPS, TIMECOLLAPSE] //Stores all the element types (essentially the classes)
